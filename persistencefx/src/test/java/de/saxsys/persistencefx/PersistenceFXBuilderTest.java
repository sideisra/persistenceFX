...
public class PersistenceFXBuilderTest {
  ...
  public void specifiedErrorHandlerShouldBeSet() {
    final ErrorHandler<TestModel> errorHandler = new ErrorHandler<TestModel>() {

      @Override
      public void error(final Object modelEntity, final Exception error) {
        // do nothing just be an error handler ;-)
      }

      @Override
      public void rootModelListError(final Collection<TestModel> added, final Collection<TestModel> removed,
